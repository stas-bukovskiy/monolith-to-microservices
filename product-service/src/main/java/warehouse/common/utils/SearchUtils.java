...
public class SearchUtils {
     ...
     * @param searchCriteriaClass criteria based on our domain
     * @param <T>                 any class extends BaseSearchCriteria
     * @return a <T> class instance that contains pagination info
